...
function Loc() {
  return (
    <div>
      <div className="flex md:flex-row justify-center md:mx-auto items-center gap-[100px] my-[100px] flex-col">
        <iframe
          class="md:w-[700px] w-[320px]"
        ...
        <div className="flex flex-col justify-center md:w-[400px] w-[320px] items-start ">
